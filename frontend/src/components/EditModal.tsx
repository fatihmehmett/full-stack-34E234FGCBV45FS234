...
const EditModal = ({ visible, record, onClose, onSave, mode, onDelete }: any) => {
  ...
  return (
    <Modal
      ...
      footer={[
        <Button key="delete" danger type="primary" onClick={handleDelete} style={{ display: mode === 'edit' ? 'inline-block' : 'none' }}>
          Delete
        </Button>,
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Form.Item name="email" label="E-mail" rules={[{ required: true, type:'email', message: 'Please enter an E-mail' }]}>
          <Input />
        </Form.Item>
